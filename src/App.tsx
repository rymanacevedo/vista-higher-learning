    ...
    <>
      ...
      <div className="space-x-4 space-y-0 flex items-center justify-center max-[350px]:flex-col max-[350px]:space-x-0 max-[350px]:space-y-4">
        <button
          type="button"
          onClick={handleStop}
          className={`inline-flex items-center justify-center rounded-full border border-transparent cursor-pointer bg-blue-600 text-white p-4 hover:ring-[0.75em] hover:ring-blue-200 focus:ring-[0.75em] focus:ring-blue-200 transition-all ${recordingState !== 'idle' ? 'opacity-100' : 'opacity-50'}`}
        >
        ...
        <button
          ...
          className={`inline-flex items-center justify-center rounded-full border border-transparent cursor-pointer bg-red-600 text-white p-4 hover:ring-[0.75em] hover:ring-red-200 focus:ring-[0.75em] focus:ring-red-200 transition-all ${recordingState === 'recording' ? 'ring-[0.75em] ring-red-200' : ''}`}
        >
        ...
        <button
          ...
          className={`inline-flex items-center justify-center rounded-full border border-transparent cursor-pointer bg-green-800 text-white p-4 hover:ring-[0.75em] hover:ring-green-200 focus:ring-[0.75em] focus:ring-green-200 transition-all ${recordingState === 'reviewing' ? 'ring-[0.75em] ring-green-200' : ''}`}
        >
